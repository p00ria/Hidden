...
local function run(msg, matches)
  if matches[1]:lower() == 'red' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "red" then -- Put everything you like :)
...
return {
	usage = {
		...
		"/stats red: Return Users And Groups Stats.",
		"/redbot: Return About Text.",
		},
  patterns = {
    "^[!/]([Ss]tats)$",
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (red)",-- Put everything you like :)
		"^[!/]([Rr]edbot)"-- Put everything you like :)
    }, 
  run = run
}
